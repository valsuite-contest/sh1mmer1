...
tar -cvf ../wax4web/wax4web.tar wax4web_entry.sh wax.sh str1pper.sh bootstrap m1nsh1m_legacy m1nsh1m_bw payloads firmware lib/wax_common.sh lib/shflags lib/bin/i386/cgpt --owner=0 --group=0
cd ../wax4web
